...
const LOC_REGIONS = ['vermont', 'new york', 'illinois', 'iowa', 'pennsylvania', 'connecticut', 'oregon', 'missouri', 'capital region', 'west virginia', 'california', 'ohio', 'louisiana', 'lyon', 'kansas', 'kentucky', 'norfolk', 'district of columbia', 'ontario', 'north carolina', 'nevada', 'massachusetts', 'brittany', 'punjab', 'new jersey', 'maine', 'new south wales', 'virginia', 'indiana', 'utah', 'arkansas', 'tennessee', 'florida', 'maryland', 'colorado', 'texas', 'montana', 'alabama', 'minnesota', 'south carolina', 'idaho', 'hawaii', 'sheffield', 'oklahoma', 'baghdad', 'portsmouth', 'greater london', 'wisconsin', 'georgia', 'alaska', 'arizona', 'new hampshire', 'michigan', 'cornwall', 'bristol', 'washington'];
const COMP_COUNTRIES = ['france', 'united kingdom', 'germany', 'canada', 'denmark', 'iraq', 'united states', 'australia', 'mexico', 'finland', 'japan'];
const COMP_REGIONS = ['capital region', 'idaho', 'indiana', 'minnesota', 'oregon', 'wisconsin', 'new jersey', 'ontario', 'bavaria', 'greater london', 'alabama', 'virginia', 'uusimaa', 'england', 'arkansas', 'texas', 'connecticut', 'kansas', 'district of columbia', 'île-de-france', 'arbil', 'massachusetts', 'north dakota', 'surrey', 'maine', 'arizona', 'louisiana', 'vermont', 'maryland', 'rhode island', 'missouri', 'sheffield', 'oklahoma', 'illinois', 'north carolina', 'georgia', 'brittany', 'nebraska', 'florida', 'california', 'pennsylvania', 'ohio', 'washington', 'tennessee', 'delaware', 'auvergne-rhône-alpes', 'new york', 'alaska', 'michigan'];
